...
if __name__ == '__main__':
    ...
    for name in names:
        ...
        for trial in range(num_trials):
            ...
            hyperparams = AttrDict({"dropout": dropout, "num_layers": num_layers, "dim": dim, "learning_rate": learning_rate, "weight_decay": weight_decay, "max_iterations": max_iterations, "temperature": temperature})

            G = to_networkx(dataset.graph, to_undirected=True)

            for i in range(hyperparams.max_iterations):
        ...
        f.write("\n" + "Best hyperparameters for " + name + ": " + str(best_hyperparams))
        f.close()

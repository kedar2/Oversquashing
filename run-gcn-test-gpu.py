...
def run(_):
    ...
    hyperparams = {
    "cornell": AttrDict({"dropout": 0.3060, "num_layers": 6, "dim": 128, "learning_rate": 0.0082, "weight_decay": 0.1570}),
    "texas": AttrDict({"dropout": 0.2346, "num_layers": 6, "dim": 128, "learning_rate": 0.0072, "weight_decay": 0.0037}),
    "wisconsin": AttrDict({"dropout": 0.2869, "num_layers": 6, "dim": 64, "learning_rate": 0.0281, "weight_decay": 0.1570}),
    ...
    "actor": AttrDict({"dropout": 0.7605, "num_layers": 6, "dim": 64, "learning_rate": 0.0290, "weight_decay": 0.0619}),
